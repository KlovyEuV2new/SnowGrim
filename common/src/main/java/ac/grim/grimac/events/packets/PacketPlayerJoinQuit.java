...
public class PacketPlayerJoinQuit extends PacketListenerAbstract {
    ...
    public void onUserLogin(UserLoginEvent event) {
        ...
        if (platformPlayer.hasPermission("snowgrim.alerts.enable-on-join") && platformPlayer.hasPermission("grim.alerts")) {
        ...
        if (platformPlayer.hasPermission("snowgrim.verbose.enable-on-join") && platformPlayer.hasPermission("grim.verbose")) {
        ...
        if (platformPlayer.hasPermission("snowgrim.brand.enable-on-join") && platformPlayer.hasPermission("grim.brand")) {
        ...
        if (platformPlayer.hasPermission("snowgrim.spectate") && GrimAPI.INSTANCE.getConfigManager().getConfig().getBooleanElse("spectators.hide-regardless", false)) {
